...
## para conseguir fila entera
mtcars[mtcars[,"gear"] == 4,,drop=FALSE]
...
#ej 6
library("readxl") #librer�a necesaria para levantar datos en formato xls o xlsx

arboles<-read_excel(file.choose()) # la ruta donde est� el archivo
